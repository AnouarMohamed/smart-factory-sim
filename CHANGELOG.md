...
- Initial architecture plan and development log.
- Vite, TypeScript, ESLint, Prettier, Vitest, and pnpm project scaffold.
- Strict shared type contracts for robot, factory, sensors, MQTT, physics, fleet, simulation, and UI.
- Core event bus, simulation clock, tick scheduler, replay, config, logger, and profiler services.
- Physics, pathfinding, robot, sensor, factory, IoT, fleet, rendering, UI, export, and firmware modules.
- Five scenario JSON files.
