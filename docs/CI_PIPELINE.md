...
|---:|---|---|
| 1 | `docs/index` | Documentation index and README link. |
| 2 | `docs/architecture-deep-dive` | Architecture deep dive and system ownership docs. |
| 3 | `docs/operations-runbook` | Runbook and troubleshooting docs. |
| 4 | `docs/team-workflow` | Contributor and team workflow docs. |
| 5 | `docker/runtime` | Production Dockerfile, Nginx config, and Docker context rules. |
| 6 | `docker/compose-docs` | Compose file and Docker docs. |
| 7 | `ci/core-quality` | Core CI quality workflow. |
| 8 | `ci/docker-build` | Docker build workflow. |
| 9 | `ci/pr-hygiene` | Pull request template, CODEOWNERS, and Dependabot. |
| 10 | `docs/ci-pipeline` | Pipeline documentation and stack summary. |
